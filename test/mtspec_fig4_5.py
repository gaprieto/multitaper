...
ax1.plot(Pxy.freq[0:Pxy.nf]*86400,np.real(Pxy.trf[0:Pxy.nf]))
ax1.plot(Sxy.freq*86400,np.real(Sxy.trf))
ax2 = fig.add_subplot(2,1,2)
ax2.plot(Pxy.freq[0:Pxy.nf]*86400,np.imag(Pxy.trf[0:Pxy.nf]))
ax2.plot(Sxy.freq*86400,np.imag(Sxy.trf))
